...
import ru.itplanet.trampline.media.security.ApiAccessDeniedHandler
import ru.itplanet.trampline.media.security.ApiAuthenticationEntryPoint
import ru.itplanet.trampline.media.security.InternalApiRequestFilter
            ...
            .authorizeHttpRequests { auth ->
                auth
                    .requestMatchers(
                        ...
                        request.matcher("/actuator/health"),
                        request.matcher("/actuator/health/**")
                    ).permitAll()
